    ...
    <div class="container-fluid">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('listKasMasuk') }}" method="get" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-3">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('rkKasMasuk') }}" target="_blank" class="btn btn-success">
                    <span class="fas fa-print"></span> Print Rekap Kas Masuk
                </a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
